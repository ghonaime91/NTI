...
/*
 form validation and save data to file then
 read it Task 5 by Ahmed Muhammed Abdullah Muhammed
 */
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        ...
        else
        {
            ...
            $DB_file = fopen("profile.txt","w") or die("something went wrong!");
            $data  = "* Your name is ".$name."\n"."* Your password is ".$pass."\n";
            $data .= "* Your address is ".$address."\n"."Your E-mail is ".$email."\n";
            $data .= "* Your gender is ".$_POST["gender"]."\n";
            $data .= "* Your Linked In URL is\n".$linkedin."\n";
            fwrite($DB_file,$data);
            fclose($DB_file);
